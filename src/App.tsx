...
const CabinUI = ({ 
  ...
  // 【修复】：彻底修改 AI System Prompt，只保留原话，仅作错别字修正
      ...
      const response = await fetch('https://api.minimax.chat/v1/text/chatcompletion_v2', {
        ...
        body: JSON.stringify({ 
          ...
          messages:[ 
            { 
              role: "system", 
              content: "你是一个文字整理助手。请仅仅修复用户输入文本中的错别字，并去掉'啊'、'呃'、'那个'等无意义的语气词，使句子通顺。必须完全保留用户的原意和第一人称语气，绝对不要去总结它，不要擅自加上任何解释、前缀或套话。直接输出修正后的原话。" 
            }, 
